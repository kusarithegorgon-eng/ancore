...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ancrest — Workflow Studio" },
      { name: "description", content: "Ancrest: a premium visual workflow studio for building API automations." },
      { name: "author", content: "Ancrest" },
      { property: "og:title", content: "Ancrest — Workflow Studio" },
      { property: "og:description", content: "Premium visual workflow studio for API automations." },
